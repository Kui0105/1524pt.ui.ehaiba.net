...
const initCategories: CategoryItem[] = [
    { id: 1, name: '推理', status: 1, createTime: nowCreate(45) },
    { id: 2, name: '情感', status: 1, createTime: nowCreate(40) },
    { id: 3, name: '恐怖', status: 1, createTime: nowCreate(36) },
    { id: 4, name: '欢乐', status: 1, createTime: nowCreate(30) },
    { id: 5, name: '古风', status: 1, createTime: nowCreate(25) },
    { id: 6, name: '阵营', status: 0, createTime: nowCreate(20) },
    { id: 7, name: '硬核', status: 1, createTime: nowCreate(15) }
]
